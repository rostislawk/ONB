...
*******************************************************************************
\file stack.h
\brief Управление контролируемым стеком
*//****************************************************************************
...
/*
*******************************************************************************
Создание / освобождение стека
*******************************************************************************
*/

/*!	\brief Создание стек

	Создается стек размера size.
	\remark При создании стека все его октеты обнуляются.
	\return Указатель на стек. Нулевой указатель возвращается
...
/*!	\brief Очистить и освободить стек

	Выполняется очистка и освобождение стека stack.
*/
void stackClose(
	void* stack			/*!< [in] стек */
);
