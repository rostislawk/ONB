...
Функции tmFreq(), tmTicks() отвечают за работу с наиболее точным
таймером среди доступных. Показания выдаются в виде значения типа tm_ticks_t.
