...
*******************************************************************************
\file rng.h
\brief Источники случайности и генератор случайных чисел
*//****************************************************************************
...
err_t rngReadSource(
	...
	void* source_name	/*!< [in/out] имя источника */
);
...
\safe Обрабатываемые данные не считаются секретными. Эти данные не должны 
использовать для построения ключей.

todo: оценка энтропии.
*******************************************************************************
*/
...
/*!	\brief Тест знаков FIPS 140
	...
	\remark Определяется велична S -- число единиц в последовательности.
...
/*!	\brief Покер-тест FIPS 140
	...
	S = 16 \sum_{i=0}^15 S_i^2 - (5000)^2, где S_i -- количество появлений 
...
/*!	\brief Тест серий FIPS 140
	...
	\remark Бит с номером i: wordTestBit((const word*)buf, i). 
*/
bool_t rngTestFIPS3(
	const octet buf[2500]	/*!< [in] тестируемая последовательность */
);
