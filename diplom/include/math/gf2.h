...
*******************************************************************************
\file gf2.h
\brief Арифметика в поле GF(2^m)
*//****************************************************************************
...
заданные в функциях polyRedTrinomial(), polyRedPentanomial().
...
из общих функций редукции polyRedTrinomial() или polyRedPentanomial().
...
#define gf2IsIn(a, f)\
	(gf2Deg(f) % B_PER_W == 0 || wordCmp(a, (f)->mod, (f)->n) < 0)
