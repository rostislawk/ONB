...
/*!	\brief Выполнение BMQV стороной B
	...
	от лица стороны B по каналу file c функциями чтения read и записи write.
...
/*!	\brief Выполнение BMQV стороной A
	...
	Протокол BMQV с параметрами params и настройками settings выполняется 
	от лица стороны A по каналу file c функциями чтения read и записи write. 
...
/*!	\brief Выполнение BPACE стороной B
	...
	лица стороны B по каналу file c функциями чтения read и записи write. 
...
/*!	\brief Выполнение BPACE стороной A
	...
	Протокол BPACE с параметрами params и настройками settings выполняется от 
	лица стороны A по каналу file c функциями чтения read и записи write. 
